...
<div class="container">
  ...
  <form action="toCreate.php" method="POST">
...
include("../connection/conn.php");
  ...
  $sql="SELECT * from tblProfesor";
    ...
    while($mostrar=mysqli_fetch_assoc($result)) { ?>
        <option value="<?php echo $mostrar['idProfesor'] ?>"><?php echo $mostrar['nombresProfesor'];?>&nbsp<?php echo $mostrar['apellidosProfesor']; ?></option>
        <?php } ?>
      </select>
    </div>
    ...
    <button type="submit" class="btn btn-primary">Ingresar</button>   <a href="verAlumno.php"><input type="button" value="Volver" class="btn btn-primary"></a>
